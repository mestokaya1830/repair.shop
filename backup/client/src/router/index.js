    ...
    //admin
    {
      ...
      children: [
        //dashboard
        {
          ...
          {
            path: "repairs",
            component: () => import("@/views/admin/dashboard/AdminRepairs.vue"),
          },
          {
            path: "repairs/:id/details",
            name: "AdminRepairDetails",
            component: () => import("@/views/admin/dashboard/AdminRepairDetails.vue"),
          },
  
          {
            path: "customers",
            name: "AdminCustomers",
            component: () => import("@/views/admin/dashboard/AdminCustomers.vue"),
          },
  
          {
            path: "technicians",
            name: "AdminTechnicians",
            component: () => import("@/views/admin/dashboard/AdminTechnicians.vue"),
          },
          ]
        },
